...
export function sameOrigin(request){try{const origin=request.headers.get('Origin');if(!origin)return true;return origin===new URL(request.url).origin}catch{return false}}
